...
qwerty.addEventListener('click', (e) => {
    ...
    if (e.target.tagName === "BUTTON") {
        ...
        if (letterFound === null) {
            ...
            //var myAudio = new Audio('audio/cardTurning-1.mp3');
...
startButton.addEventListener('click', (e) => {
    ...
    // play/pause sound to allow user access and get past security requirements
    document.getElementById("cardSound").play();
    document.getElementById("cardSound").pause();
});